 ...
 <div class="productos">
    ...
    <div class="box-imagen belen">
      <img src="publicidades/aviso-grafico.png" width="191" height="269"> 
       ...
       <h3>Aviso Gráfico</h3>
      <p>Las comunicaciones en medios zonales permiten crear una sólida imagen de marca entre el distribuidor y Nufarm.</p>
...
if($_SESSION['MM_IdUsuario']){
 ...
 <form id="forevent" method="post" name="form1" action="envio_correo.php">
				         ...
				         <input type="hidden" name="envio_desde" value="aviso_grafico">
				...
				value="<?php if($_SESSION['fecha']){echo $_SESSION['fecha'];} ?>" size="32">
                     ...
                     <textarea name="strcaracteristicas" cols="" id="textocampo"><?php if($_SESSION['caracteristicas']){echo $_SESSION['caracteristicas'];} ?>
                     </textarea>
				                         </div>
