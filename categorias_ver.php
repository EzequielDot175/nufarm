...
<article>
 <h3>Productos...</h3>
  ...
  <?php do { ?>
     <ul>
            <li>
             <div class="tipro"><p>$<?php echo $row_DatosProductos['dblPrecio']; ?><p></div>
    <a href="ver_producto.php?recordID=<?php echo $row_DatosProductos['idProducto']; ?>"><img src="documentos/img/<?php echo $row_DatosProductos['strImagen']; ?>" width="156" height="158"></a><br />
     <div class="info">
    <span><a href="ver_producto.php?recordID=<?php echo $row_DatosProductos['idProducto']; ?>">Canjear</a></span>    
                </div>
                                          
                                            </li>
                                            <div class="descripcion">
                                             <h4><?php echo $row_DatosProductos['strNombre']; ?></h4> 
