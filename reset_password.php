...
<div class="logo-login"></div>
  ...
  <div id="logincaja">
  <h2></h2>
    <form id="send_new_pas" action='send_new_pas.php?entrykey=<?php echo $entrykey?>&emailconfirmation=<?php echo $emailconfirmado ?>' method='POST' enctype='multipart/form-data'> 
        <p><center>Ingrese su contraseña</center></p>
       <br>
       <label> <?php echo $emailconfirmado ?></label> 
	   <br /><br />
		<label>Nueva contraseña</label> 
        <input name="newpass" type="text" id="email"  />
       <br /><br />

        <input type="submit" name="button" id="button" value="REESTABLECER CONTRASEÑA" /><br />
