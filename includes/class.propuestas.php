...
echo '
<tr>
<td class="header_table_canjeados" colspan="6">	PROPUESTA: '.$fecha_estimada.'</td>
</tr>
<tr>
<td align="center" class="monto-total">$'.$monto_actual.'</td>
<td>'.$caracteristicas.'</td>
<td class="estado-carrito">'.$estado.'</td>
</tr>
