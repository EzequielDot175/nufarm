...
/* SELECT METHOD / LOAD */
function select($id){
$sql =  "SELECT * FROM talles_productos WHERE id = $id;";
...
$sql ="SELECT cantidad FROM talles_productos WHERE id_producto = '$id_producto' ;";
$result = $this->database->query($sql);
$result = $this->database->result;
while($row = mysql_fetch_array($result)){
...
$sql ="SELECT * FROM talles_productos WHERE id_producto = '$id_producto' AND id_talle = '$id_talle' ;";
$result =  $this->database->query($sql);
$result = $this->database->result;
$row = mysql_fetch_object($result);
...
$sql = " UPDATE talles_productos SET id_talle = '$this->id_talle', id_producto = '$this->id_producto', cantidad = '$this->cantidad' WHERE id = $id ";
