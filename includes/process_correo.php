...
$mail->FromName = "Web Productos Nufarm";
$mail->Subject = "Contacto desde productosnufarm.com";
$mail->AddAddress("estudio@dot175.com","estudio@dot175.com");
$mail->AddBCC("mknet@productosnufarm.com");
$mail->Body = $msg;
