...
<head>
	...
	<body ng-controller="CTRLClientController">
			...
			<div class="base">
				...
				<div class="contenido col-xs-12 col-sm-12 col-md-12 ol-lg-12">
					...
					<div class="admin col-xs-12 col-sm-12 col-md-12 ol-lg-12">
						...
						<h3 class="titulo-B"><?php echo strtoupper(Auth::User()->strEmpresa) ?></h3> 
								...
								<table class="tabla-A tabla-mes" >
									...
									<tbody>
										...
										<tr>
											...
											<td ng-repeat="(key, val) in facturacion.data" ng-cloak class=" background-A text-uppercase center">
												{{ val.facturacion }}
											</td>
