...
<div class="separador MC_2">
   ...
   <tr class="tablacolor3">
     ...
     <td  class="rotate2" width="32%" height="20px" align="left">Producto</td>
     <td  class="rotate2" width="11%" height="20px" align="left">Unidad</td>
	 <td  class="rotate2" width="11%" height="20px" align="left">Talle</td>
	  <td  class="rotate2" width="11%" height="20px" align="left">Color</td>
    ...
    <tr bgcolor="#FFFFFF" style="font-size: 12px;">
              ...
              <td class="header_table_canjeados" colspan="7">CANJE
	 ...
	 <!--<tr class="linetable_green" colspan="6"  height="1px" align="center"></tr>-->
        ...
        <td class="td_shadow shadowright" align="center">
       ...
       <td colspan="6" style="padding-left:10px;width: 100%;padding-bottom: 28px;"><?php 
...
<div class="carritotabla">
 <table width="100%" border="0" align="center"  cellspacing="0">
   <tr class="tablacolor">
     ...
     <td class="rotate" width="28%" height="20px" align="left">Productos</td>
     <td class="rotate" width="4%" height="20px" align="left">Unidades</td>
	 <td class="rotate" width="4%" height="20px" align="left">Talle</td> 
	 <td class="rotate" width="4%" height="20px" align="left">Color</td> 	 
     <td class="rotate" width="4%" height="20px" align="left">Precio</td>
     <td  width="14%" height="20px" align="left">Acciones</td>
   </tr>
   <?php $preciototal = 0;?>
   <?php do { ?>
