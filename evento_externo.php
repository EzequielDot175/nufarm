...
<div id="avisos_productos">
 ...
 <div class="productos">
       ...
       <div class="box-imagen belen">
        ...
        <h3>Evento Externo</h3>
        <p>Eventos zonales, exposiciones y jornadas, 
organizadas por instituciones y/o asociaciones, El distribuidor y Nufarm podrán estar presente mediante sponsoreos, patrocinios o presencia de marca.</p>
     </li>
         </ul>
            </div><!---- Fin box-content ---->
...
<input type="hidden" name="envio_desde" value="evento_externo">
<div class="formtit">Nombre del evento</div>
   						       <input id="dato" type="text" name="strnombrecompleto" 
   						value="<?php if($_SESSION['strnombrecompleto']){echo $_SESSION['strnombrecompleto'];} ?>" size="32">
   						...
   						value="<?php if($_SESSION['fecha']){echo $_SESSION['fecha'];} ?>" size="32">
                             ...
                             <textarea name="strcaracteristicas" cols="" id="textocampo"></textarea>
   						                         </div>
