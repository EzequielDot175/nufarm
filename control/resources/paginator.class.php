	...
	function paginate()
	{
		...
		if($this->num_pages > 10)
		{
			...
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				{
					$this->return .= ($i == $this->current_page And $_GET['page'] != 'Todo') ? "<a title=\"Go to page $i of $this->num_pages\" class=\"current\" href=\"#\">$i</a> ":"<a class=\"paginate\" title=\"Go to page $i of $this->num_pages\" href=\"$_SERVER[PHP_SELF]?page=$i&amp;ipp=$this->items_per_page$this->querystring\">$i</a> ";
				}
				if($this->range[$this->mid_range-1] < $this->num_pages-1 And $i == $this->range[$this->mid_range-1]) $this->return .= " ... ";
			}
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($_GET['page'] != 'Todo')) ? "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$next_page&amp;ipp=$this->items_per_page$this->querystring\">Siguiente &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Siguiente</span>\n";
			$this->return .= ($_GET['page'] == 'Todo') ? "<a class=\"current\" style=\"margin-left:10px\" href=\"#\">Todo</a> \n":"<a class=\"paginate\" style=\"margin-left:10px\" href=\"$_SERVER[PHP_SELF]?page=1&amp;ipp=Todo$this->querystring\">Todo</a> \n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
