...
echo '<div class="menuorden"><a href="v_categorias.php?orden=1"><img src="../layout/btn-orden1.png" alt="desc"/></a><a href="v_categorias.php?orden=2"><img src="../layout/btn-orden2.png" alt="desc"/></a></div>';
/* SELECT */
echo '<div id="content-prod">';
echo '<div class="barra-prod"><span>ADMINISTRAR CATEGORÍAS</span></div>';
include_once("classes/class.categorias.php");
$categorias= new categorias();
$categorias->select_all($pagina, $orden);
echo '<a  class="cat-add" href="n_categoria.php">CREAR NUEVO</a>';
echo '</div>';
?>	
</div>	
