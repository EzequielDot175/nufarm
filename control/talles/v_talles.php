...
echo '<div class="menuorden"><a href="v_talles.php?orden=1"><img src="../layout/btn-orden1.png" alt="desc"/></a><a href="v_talles.php?orden=2"><img src="../layout/btn-orden2.png" alt="desc"/></a></div>';
/* SELECT */
echo '<div id="content-prod">';
echo '<div class="barra-prod"><span>ADMINISTRAR TALLES</span></div>';
include_once("classes/class.talles.php");
$talles= new talles();
$talles->select_all($pagina, $orden);
echo '<div class="linea-talles"></div>';
echo '<a  class="cat-add" href="n_talle.php">CREAR NUEVO</a>';
echo '</div>';
?>	
</div>	
