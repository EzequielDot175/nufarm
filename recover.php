...
if (isset($_POST['strEmail'])) {
  ...
  $password=$_POST['strPassword'];
  $MM_fldUserAuthorization = "";
  $MM_redirectLoginSuccess = "canjes.php";
  $MM_redirectLoginFailed = "acceso_error.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_conexion, $conexion);
...
<div class="logo-login"></div>
  ...
  <div id="login">
   <div id="menu">
      <a href="login.php"><div class="link-login2"><span class="home_icon_login"></span>INICIAR SESIÓN</div></a>
       <a href="recover.php"><div class="link-login-activo2-green"><span class="home_icon_login2-green"></span><div style="margin-left:25px">RECUPERAR PASS</div></div></a>
  </div>
  <div id="logincaja">
  <h4></h4>
  <br />
    <form id="loginform" name="form1" method="post" action="send_new_pas.php">
      <p><center>
      Recuperar Contraseña <br><br>
      Introduzca su correo electrónico en el campo que figura debajo. Se le enviará un correo electrónico de confirmacion para cambiar su contraseña.</center></p>
      <br>
      <label>Correo Electronico</label>
       ...
       <br /><br />
        ...
        <center class="center"> 
     <a class="btn-login">
    <input type="submit" name="button" id="button-login" value="Enviar correo">
    </a>
        </center>
